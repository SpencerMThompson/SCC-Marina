...
namespace SCC_Marina.Controllers
{
    public class DocksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Location,Electricity,Water")] Dock dock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Location,Electricity,Water")] Dock dock)
        {
            if (ModelState.IsValid)
            {
